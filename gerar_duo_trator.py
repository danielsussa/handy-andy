...
PROMPT = (
    ...
    "proportions. Position the tractor so that ITS TOP edge sits at "
    "around 8-12% from the canvas top (high up) and ITS BOTTOM edge "
    "around 60-65% from the canvas top — leaving the bottom 35% of the "
    "right side as EMPTY cream paper (for body text added later). "
    "Remove any heavy ground/setting under the tractor — render it as a "
    "floating diagrammatic element on cream paper, matching the engine "
    "on the left. No heavy ground line, no detailed setting. "
    ...
    "\n\n"
    "Landscape orientation 1.5:1 (1536x1024). Composition rules: "
    "- TOP-LEFT 20% × 15% open for title. "
    "- BOTTOM-RIGHT 50% width × 30% height kept mostly empty (body text "
    "lives there). "
